...
class hash_crack:
    ...
    def argument(self):
        ...
        argu.add_argument('-m', '--mode', required=True, dest="mode_hash", help="Write the type of the passwords [-m MD5 || -m LM]")
    ...
    def check_data(self):
        ...
        if (self.arguments.mode_hash.upper() == "MD5"):
            ...
            print(colored("[!] Bad Mode: Available modes = MD5 || LM", 'red'))
